...
ActiveRecord::Schema.define(version: 20170719153467) do
  ...
  create_table "decidim_features", id: :serial, force: :cascade do |t|
    ...
    t.index ["featurable_id", "featurable_type"], name: "index_decidim_features_on_featurable_id_and_featurable_type"
  end
  ...
  add_foreign_key "decidim_assemblies", "decidim_organizations"
